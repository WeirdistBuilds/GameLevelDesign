...
//Name: Rug.ma
//Last modified: Fri, Feb 28, 2020 08:52:25 AM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.4064432747637632 4.1235218514932388 -11.186280547400447 ;
	setAttr ".r" -type "double3" -17.738352729602159 150.19999999999581 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "9C34A53E-495F-CCF2-7CA5-96BCFC7A9613";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 13.534357035990244;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.33422154188156128 0.49737255834043026 ;
	setAttr -s 2 ".uvst";
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".uvst[1].uvsn" -type "string" "RugLightmap";
	setAttr ".cuvs" -type "string" "RugLightmap";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E541F3C8-4B57-E44F-E04A-34B9940C7416";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "2BE14725-4DB7-912E-842A-F2A6F865B53C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "A5BB8B96-474A-D245-1F75-0C9476AB3653";
createNode displayLayerManager -n "layerManager";
	rename -uid "16545D60-408F-2FB4-3A48-FA891A06B98F";
createNode displayLayer -n "defaultLayer";
	rename -uid "19BC4BFC-4DBA-44B8-2963-269937E43BD1";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1659E414-4D3C-18AA-D757-7A936C0FF0FA";
...
createNode polyTweakUV -n "polyTweakUV1";
	...
	setAttr ".uopa" yes;
	setAttr -s 3 ".uvtk";
	setAttr ".uvtk[15]" -type "float2" -0.0033978154 0.00010976161 ;
	setAttr ".uvtk[16]" -type "float2" -0.0010929846 -0.24968494 ;
...
createNode polyTweak -n "polyTweak2";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk";
	setAttr ".tk[8]" -type "float3" -0.37648511 0 0.63263088 ;
	setAttr ".tk[9]" -type "float3" 0.37648511 0 0.63263088 ;
	setAttr ".tk[10]" -type "float3" 0.37648511 -0.13996571 0.63263088 ;
	setAttr ".tk[11]" -type "float3" -0.37648511 0 0.63263088 ;
	setAttr ".tk[12]" -type "float3" -0.37648511 0 -0.63263088 ;
	setAttr ".tk[13]" -type "float3" 0.37648511 0 -0.63263088 ;
	setAttr ".tk[14]" -type "float3" 0.37648511 0 -0.63263088 ;
	setAttr ".tk[15]" -type "float3" -0.37648511 0 -0.63263088 ;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "polyCopyUV1.out" "pCubeShape1.i";
