...
//Name: Tree3.ma
//Last modified: Sun, Feb 09, 2020 11:03:14 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.4673846337898433 13.004161993289582 -1.861258528745539 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 2.6611286828739646;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.86645463109016418 12.932721087379555 0.26324734091758728 ;
...
createNode mesh -n "TreeShape3" -p "Tree3";
	...
	setAttr ".cuvs" -type "string" "Tree3Lightmap";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D99F0192-42C8-8679-D19D-2C882FEAB5F0";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "93FF016C-4EBA-11EB-A1D8-11841E79D815";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C8AD05D0-44FE-4012-6332-05B034E014AC";
createNode displayLayerManager -n "layerManager";
	rename -uid "04E9433F-43F4-54A3-E02A-73B0C63F0BD4";
createNode displayLayer -n "defaultLayer";
	rename -uid "46F56E54-4C67-A1C6-23F4-21B30230946C";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F95DB71A-4820-2796-5749-619C54E86984";
...
createNode polyTweak -n "polyTweak43";
	...
	setAttr ".uopa" yes;
	setAttr -s 4 ".tk";
	setAttr ".tk[263]" -type "float3" -0.025809031 0.00021465265 -0.018777207 ;
	setAttr ".tk[264]" -type "float3" 0.056007851 0.13651049 0.046021692 ;
	setAttr ".tk[265]" -type "float3" 0.055901125 -0.00028413365 0.066791952 ;
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "polyCopyUV1.out" "TreeShape3.i";
