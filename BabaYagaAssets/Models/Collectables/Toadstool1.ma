...
//Name: Toadstool1.ma
//Last modified: Mon, Feb 03, 2020 07:30:34 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.3091541591713276 -1.632352781792717 -2.033446179266492 ;
	setAttr ".r" -type "double3" 36.261647270381559 -229.79999999997375 0 ;
...
createNode polyTweak -n "polyTweak5";
	...
	setAttr ".uopa" yes;
	setAttr -s 23 ".tk";
	setAttr ".tk[142]" -type "float3" 0.036776245 -0.0029817361 -0.015252304 ;
	setAttr ".tk[143]" -type "float3" 0.030745856 -0.0027975487 -0.025533212 ;
	setAttr ".tk[144]" -type "float3" 0.021245947 -0.0022541438 -0.032769743 ;
	setAttr ".tk[145]" -type "float3" 0.0097233085 -0.0015204572 -0.036458407 ;
	setAttr ".tk[146]" -type "float3" -0.0022846989 -0.00068712706 -0.036632832 ;
	setAttr ".tk[147]" -type "float3" -0.013353957 0.00012307712 -0.033933599 ;
	setAttr ".tk[148]" -type "float3" -0.022683274 0.00091489486 -0.029063907 ;
	setAttr ".tk[149]" -type "float3" -0.030042235 0.0016590472 -0.022304041 ;
	setAttr ".tk[150]" -type "float3" -0.035321362 0.0022515012 -0.013873817 ;
	setAttr ".tk[151]" -type "float3" -0.038323883 0.0026808677 -0.0038437727 ;
	setAttr ".tk[152]" -type "float3" -0.038511019 0.0029324123 0.0072711073 ;
	setAttr ".tk[153]" -type "float3" -0.035271194 0.0029817366 0.018247435 ;
	setAttr ".tk[154]" -type "float3" -0.028477117 0.0027942751 0.027674248 ;
	setAttr ".tk[155]" -type "float3" -0.018522602 0.0023139443 0.034074984 ;
	setAttr ".tk[156]" -type "float3" -0.0064341458 0.0015686932 0.036632832 ;
	setAttr ".tk[157]" -type "float3" 0.0064493967 0.00062014366 0.035186082 ;
	setAttr ".tk[158]" -type "float3" 0.018675612 -0.0004317853 0.029708363 ;
	setAttr ".tk[159]" -type "float3" 0.028850431 -0.0014293115 0.020776084 ;
	setAttr ".tk[160]" -type "float3" 0.035751168 -0.002248113 0.0093972385 ;
	setAttr ".tk[161]" -type "float3" 0.038511019 -0.0027950087 -0.003119563 ;
